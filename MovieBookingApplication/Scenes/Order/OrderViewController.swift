...
//      //  payButton.addTarget(self, action: #selector(navigateToOrder), for: .touchUpInside)
//    
//    }
//    
...
//    }
//    
//    @objc private func presentPaymentMethods() {
//        let paymentMethodsVC = PaymentMethodsViewController()
//        paymentMethodsVC.modalPresentationStyle = .formSheet // You can choose another presentation style if needed
//        present(paymentMethodsVC, animated: true, completion: nil)
//    }
//}
import UIKit
...
//        paymentMethodVC.modalPresentationStyle = .pageSheet
